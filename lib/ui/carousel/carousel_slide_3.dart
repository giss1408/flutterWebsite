        ...
        children: [
          Positioned(
            ...
            child: WidgetSlideUpDownFadeAnimation(
              duration: getSlideItemAnimationDuration("stock-market-2616931_1280", slideItems),
              direction:
                  getSlideItemAnimationVisibility("stock-market-2616931_1280", slideItems),
              offset: slideItemOffset,
              child:
                  Image.asset("assets/images/stock-market-2616931_1280.jpg", fit: BoxFit.fill),
            ),
          ),
          Positioned(
            left: 260,
            ...
            child: WidgetSlideUpDownFadeAnimation(
              duration:
                  getSlideItemAnimationDuration("slide_3-layer_2_Test", slideItems),
              direction: getSlideItemAnimationVisibility(
                  "slide_3-layer_2_Test", slideItems),
              offset: slideItemOffset,
              child: Image.asset("assets/images/slide_3-layer_2_Test.png",
                  fit: BoxFit.fill),
            ),
          ),
          Positioned(
            ...
            child: WidgetSlideUpDownFadeAnimation(
              duration:
                  getSlideItemAnimationDuration("slide_3-layer_1_Test", slideItems),
              direction: getSlideItemAnimationVisibility(
                  "slide_3-layer_1_Test", slideItems),
              offset: slideItemOffset,
              child: Image.asset("assets/images/slide_3-layer_1_Test.png",
                  fit: BoxFit.fill),
            ),
          ),
          Positioned(
