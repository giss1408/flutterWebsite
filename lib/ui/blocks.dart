              ...
              children: [
                Padding(
                  ...
                  child: buildMaterialIconCircle(
                      ...
                      "assets/images/icon_development.png",
                      68),
                ),
                const Padding(
                  padding: EdgeInsets.only(bottom: 16),
                  child: Text("Déployement Rapide ",
                      style: headlineSecondaryTextStyle,
                      textAlign: TextAlign.center),
                ),
                const Text(
                    "Le succès de votre business dépends de la flexibilité et de la rapidité de mise en ligne des solutions adaptées au marché. Faites l' expérience de solutions intuitives, flexibles et rapides.",
                    style: bodyTextStyle,
                    textAlign: TextAlign.center),
              ],
            ),
          ...
          ResponsiveRowColumnItem(
            ...
            child: Column(
              children: [
                ...
                const Padding(
                  padding: EdgeInsets.only(bottom: 16),
                  child: Text("Expressive et Flexible UI",
                      style: headlineSecondaryTextStyle,
                      textAlign: TextAlign.center),
                ),
                const Text(
                    "Lancez rapidement des fonctionnalités en mettant l'accent sur l'expérience native de l'utilisateur final, avec une personnalisation complète, ce qui se traduit par un rendu incroyablement rapide et des conceptions expressives et flexibles.",
                    style: bodyTextStyle,
                    textAlign: TextAlign.center),
              ],
            ),
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      const TextSpan(
                          text:
                              "Créez des campagnes adaptées à votre marché. Les couleurs, le design et les choix de médias sont de votre ressort. Nous boostons votre produit. "),
                      TextSpan(
                          recognizer: TapGestureRecognizer()..onTap = () {},
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text("Solutions Business Innovantes", style: headlineTextStyle),
                  ),
                  RichText(
                    text: TextSpan(
                      style: bodyTextStyle,
                      children: [
                        ...
                        const TextSpan(
                            text:
                                " transforment rapidement vos idées en réalité business. Développement agile, déploiement sécurisé et évolution continue pour maximiser votre ROI et accélérer votre croissance."),
                        const TextSpan(text: "\n\n"),
                        TextSpan(
                            recognizer: TapGestureRecognizer()..onTap = () {},
                            //openUrl(
                  ...
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                          recognizer: TapGestureRecognizer()
                            ..onTap = () {
                              //openUrl("https://groups.google.com/forum/#!forum/flutter-dev");
                            },
                          text: "Tourisme"),
                      const TextSpan(text: "  •  "),
                      TextSpan(
